...
@R11 will hold the output binary
...
@Store register into data (develping char array)
@Get the number of input gpio's
@Create a register with value #1, and shift it the number of input gpios to the left
@And it with the binary read result
@If it's not 0, then strb #49 in a memory address
@
